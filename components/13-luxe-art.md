...
### 44.26 IP形象艺术组合 IP Character Composition

将主人物（纯 CSS 绘制）、三层同心圆环、半圆弧线、头像徽章、签名标签、散落彩色圆点、金色短线、品牌标签、年份水印、菱形装饰、角框、N°编号、十字加号等装饰元素组合为一个完整艺术画面。主容器 `ip-composition` 内绝对定位各装饰层，主人物浮动动画与装饰层反向浮动形成呼吸感。
...
<div class="ip-composition">
  ...
  <!-- 散落彩色圆点 -->
  <span class="ip-dot d1"></span>
  <span class="ip-dot d2"></span>
  <span class="ip-dot d3"></span>
  <span class="ip-dot d4"></span>
  <!-- 金色短线装饰 -->
  <span class="ip-line l1"></span>
  <span class="ip-line l2"></span>
  <!-- 十字加号 -->
  <span class="ip-plus p1"></span>
  <span class="ip-plus p2"></span>
  <!-- Art Deco菱形 -->
  ...
  <div class="ip-character">
    <div class="ip-hair"></div>
    <div class="ip-face"></div>
    <div class="ip-eyes"></div>
    <div class="ip-body"></div>
    <div class="ip-collar"></div>
  </div>
  <!-- 金环头像徽章 -->
  <div class="ip-avatar-badge">FH</div>
  <!-- 金色便签签名标签 -->
  <div class="ip-signature">
    <span class="sig-title">Creative Director</span>
    <span class="sig-name">Feihong</span>
  </div>
  <!-- 星号前缀品牌标签 -->
  <div class="ip-tag">Feihong Design System</div>
  <!-- N°编号装饰 -->
  <div class="deco-num">N°2026</div>
  <!-- 年份水印 -->
  <div class="ip-year">2026</div>
</div>
```
```css
/* IP形象艺术组合 — 整体容器 */
...
.ip-dot.d1 {
  ...
  box-shadow: 0 0 8px rgba(10,36,99,0.3);
}
.ip-dot.d2 {
...
.ip-dot.d3 {
  ...
  bottom: 30%; left: 5%;
  background: var(--wine);
  box-shadow: 0 0 8px rgba(216,49,91,0.3);
}
.ip-dot.d4 {
  ...
  background: var(--royal);
  opacity: 0.6;
  box-shadow: 0 0 6px rgba(10,36,99,0.25);
}
...
.ip-plus.p1 { top: 35%; right: 8%; }
.ip-plus.p2 { bottom: 38%; left: 10%; }
...
### 44.27 纯CSS缩略图模型 Miniature CSS Thumbnail Mockup

在模板卡片（tpl-card）中使用纯 CSS 绘制页面缩略图，无需截图。包含11种模板变体：portfolio 作品集、landing 落地页、tutorial 教程、deck 演示文稿、case-study 案例、console 控制台、cards 小红书卡片、resume 简历、wechat 公众号、email 邮件、showcase 组件预览。通用基础类 `.tpl-mock` 提供圆角阴影容器，`.mock-line` 系列模拟文本行。
...
<!-- Landing 落地页缩略图 -->
<div class="tpl-mock mock-landing">
  <span class="ml-badge">免费报名</span>
  <div class="ml-title">报名<em>分享会</em></div>
...
<!-- Deck 演示文稿缩略图 -->
<div class="tpl-mock mock-deck">
  <span>设计不是<br>装饰<br><em>是表达</em></span>
</div>

<!-- Console 控制台缩略图 -->
<div class="tpl-mock mock-console" style="position:relative;">
  <div class="mc-sidebar"></div>
  <div class="mc-topbar"></div>
  <div class="mc-kpi"><div></div><div></div></div>
...
/* Portfolio 作品集 */
.mock-portfolio { width: 130px; background: #fff; padding: 10px; }
.mock-portfolio .mp-hero {
  background: linear-gradient(135deg, var(--royal), var(--royal-700));
  height: 45px; border-radius: 4px; margin-bottom: 6px;
  display: flex; align-items: center; justify-content: center;
}
.mock-portfolio .mp-hero span {
  font-family: var(--font-serif); color: var(--gold);
  font-size: 7px; font-weight: 700; letter-spacing: 0.15em;
}

/* Landing 落地页 */
.mock-landing { width: 140px; background: #fff; padding: 10px; }
.mock-landing .ml-badge {
  background: var(--gold); color: var(--royal);
  font-size: 5px; padding: 2px 6px; border-radius: 999px;
  font-weight: 600; display: inline-block; margin-bottom: 5px;
}
.mock-landing .ml-title {
  font-family: var(--font-serif); font-size: 9px; font-weight: 700;
  color: var(--ink); line-height: 1.1; margin-bottom: 4px;
}
.mock-landing .ml-title em { color: var(--royal); font-style: italic; }

/* Deck 演示文稿 */
.mock-deck {
  width: 140px; height: 100px;
  background: var(--royal); padding: 14px;
  position: relative; border-radius: 6px;
}
.mock-deck span {
  font-family: var(--font-serif); color: #fff;
  font-size: 11px; font-weight: 700; line-height: 1.1; display: block;
}
.mock-deck em { color: var(--gold); font-style: italic; }
.mock-deck::after {
...
/* Console 控制台（暗色终端风格） */
.mock-console {
  width: 130px; background: #060d1f; padding: 10px;
  border: 1px solid rgba(74,222,128,0.2); border-radius: 6px;
}
.mock-console .mc-topbar {
  height: 4px;
  background: linear-gradient(90deg, var(--terminal) 0%, rgba(74,222,128,0.3) 100%);
  border-radius: 2px; margin-bottom: 6px;
}
.mock-console .mc-sidebar {
  width: 28px; background: rgba(74,222,128,0.08);
  border-radius: 2px; position: absolute; top: 0; bottom: 0; left: 0;
}
.mock-console .mc-kpi {
  display: grid; grid-template-columns: 1fr 1fr;
  gap: 4px; margin-bottom: 6px; margin-left: 32px;
}
.mock-console .mc-kpi div {
  height: 18px; background: rgba(74,222,128,0.1);
  border-radius: 2px; border-left: 2px solid var(--terminal);
}
.mock-console .mc-chart {
  height: 30px; background: rgba(74,222,128,0.05);
  border-radius: 2px; margin-left: 32px;
  position: relative; overflow: hidden;
}
.mock-console .mc-chart::after {
  content: ''; position: absolute; bottom: 0; left: 0; right: 0; height: 60%;
  background: linear-gradient(180deg, transparent 0%, rgba(74,222,128,0.15) 100%);
...
### 44.28 三色顶部装饰条 Tricolor Top Border Accent

文档卡片（doc-card）顶部隐藏一条 3px 高的三色渐变线（皇家蓝→复古金→酒红），hover 时从左到右 scaleX 展开，配合卡片上移和金色边框变化，形成精致的交互反馈。

```html
<a href="#" class="doc-card">
  <div class="doc-icon">MD</div>
  <h3>设计系统完整指南</h3>
  <p>从品牌DNA到组件库，构建一套可扩展的设计语言体系。</p>
  <span class="doc-tag">指南 · v8.0</span>
</a>
```
```css
/* 文档卡片基础 */
