...
<div class="dark-panel contact-panel">
  ...
  <div class="contact-info">
    <a href="mailto:hello@feihong.design" class="contact-email">hello@feihong.design</a>
  </div>
  <div class="social-links" style="justify-content:center;margin-top:var(--sp-6);">
    <!-- 社交链接 -->
  </div>
  <a href="mailto:hello@feihong.design" class="btn btn-gold btn-xl" style="margin-top:var(--sp-6);">发送邮件 →</a>
</div>
```
    ...
    <div class="container">
      <div class="hero-text">
        ...
        <div class="social-links reveal reveal-delay-2">
          <a href="mailto:hello@feihong.design" class="social-link" aria-label="Email">
