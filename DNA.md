...
*This document is the foundation of the Feihong Design System. All templates, components, and scene specifications are built upon it. For skill implementation guidance, see **SKILL.md**.*
*本文件是 Feihong Design System 的基石。所有模板、组件、场景规范均在此基础上构建。技能实现指南参见 **SKILL.md**。*
